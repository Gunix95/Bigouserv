...
async def on_ready():
    ...
    await bot.change_presence(activity=discord.Activity(type=discord.ActivityType.playing, name =f"Chercher les méchants"))

@bot.command()
async def barababwa(ctx):
    await ctx.reply('**BARABABWAAAA**')
